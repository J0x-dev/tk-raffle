...
export default function TermsContent() {
  return (
    <>
      ...
      <h3 className="mt-4 mb-1 font-bold">1. Eligibility</h3>
      ...
      <h3 className="mt-4 mb-1 font-bold">2. Promo Mechanics</h3>
      <div className="space-y-2">
        <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">4. Winner Selection</h3>
      <div className="space-y-2">
        <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">5. Claiming of Prizes</h3>
      <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">6. Data Privacy & Consent</h3>
      <div className="space-y-2">
        <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">7. System Usage & Limitations</h3>
      <div className="space-y-2">
        <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">8. Disqualification & Forfeiture</h3>
      <div className="space-y-2">
        <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">9. Liability Limitation</h3>
      <p>
      ...
      <h3 className="mt-4 mb-1 font-bold">10. Governing Law</h3>
      <p>
