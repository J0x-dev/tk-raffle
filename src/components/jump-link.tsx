...
export default function JumpLink() {
  return (
    <div className="absolute -bottom-[75px] md:-bottom-20 left-1/2 z-20 w-[calc(100%-70px)] -translate-x-1/2 rounded-2xl bg-white p-3 text-warm-red shadow-lg sm:max-w-3xl sm:p-4 md:max-w-3xl md:px-6">
