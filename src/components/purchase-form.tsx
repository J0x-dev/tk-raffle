                ...
                <DialogContent className="max-w-4xl max-h-[90vh] h-full flex flex-col p-6 sm:p-8 border-none">
                  ...
                  <ScrollArea className="h-full -mx-6 sm:-mx-8 pr-4">
                    <div className="px-6 sm:px-8 pb-6 space-y-4 text-sm text-left">
                      ...
                      <h3 className="font-bold mb-2 pt-2">Information we collect</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Consent</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">How we collect information</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Use and sharing of information</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Protection and Security of Personal Data</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Retention of data</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Access</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Cookies</h3>
                      ...
                      <h4 className="font-semibold mb-2 pt-2">Cookie description</h4>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Links to other sites</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">Updates to our Privacy Policy</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">How to Contact Us</h3>
                ...
                <DialogContent className="max-w-4xl max-h-[90vh] h-full flex flex-col p-6 sm:p-8 border-none">
                  ...
                  <ScrollArea className="h-full -mx-6 sm:-mx-8 pr-4">
                    <div className="px-6 sm:px-8 pb-6 space-y-4 text-sm text-left">
                      ...
                      <h3 className="font-bold mb-2 pt-2">2. Promo Mechanics</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">3. Prizes</h3>
                      <ul className="list-disc pl-6 space-y-1">
                      ...
                      <h3 className="font-bold mb-2 pt-2">4. Winner Selection</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">5. Claiming of Prizes</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">6. Data Privacy & Consent</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">7. System Usage & Limitations</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">8. Disqualification & Forfeiture</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">9. Liability Limitation</h3>
                      ...
                      <h3 className="font-bold mb-2 pt-2">10. Governing Law</h3>
