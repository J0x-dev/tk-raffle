                    ...
                    <ScrollArea className="-mx-6 h-full pr-4 sm:-mx-8">
                      <div className="space-y-4 px-6 pb-6 text-left text-sm sm:px-8">
                        <p>
                          ...
                          and safeguarding your privacy when you visit and
                          access our website using any electronic device. This
                          Privacy Policy set forth how we collect, use, and
                          store your information.
                        </p>
                        <p>
                          This Policy applies to information shared and
                          collected from visitors of Tapa King’s official
                          website. It is not applicable to any information
                        ...
                        <ul className="list-disc space-y-1 pl-6">
                          ...
                          <li>
                            Contents of a message and/or attachments (documents
                            or pictures) voluntarily submitted by you;
                          </li>
                          <li>
                        ...
                        <p>
                          By using our website and providing us your Personal
                          Data to avail our products and services or in any
                          transaction with us where your Personal Data is
                          required, you are consenting to the collection, use,
                          access, transfer, storage, and processing of your
                          Personal Data as described in this Privacy Policy.
                          Thus, we encourage you to READ our Privacy Policy.
                        </p>
                        ...
                        <ul className="list-disc space-y-1 pl-6">
                          <li>
                            Carry out your requests, fulfilling orders,
                            processing payments, and providing delivery
                            services;
                          </li>
                          <li>
                        ...
                        <p>
                          ...
                          outside of the Philippines, on a need-to-know basis.
                          Use of your information by these entities will comply
                          with this Privacy Policy.
                        </p>
                        <p>
                          We may also share your Personal Data and other
                          information to trusted third-party entities engaged by
                          Tapa King to undertake variety of tasks, which
                          includes but not limited to, accomplishing orders,
                          assist in marketing, technical support for our online
                          services on various online platforms, and similar
                          functions. These entities may have access to your
                          Personal Data in order to perform their tasks. While
                          we endeavor to require these entities to conform with
                          appropriate privacy policies, you agree that we are
                          not responsible for any violations, nor for actions,
                          omissions or negligence of any such entities in
                          violation of this Privacy Policy.
                        </p>
                        <p>
                          Tapa King may ask you to receive marketing materials
                          from our business partners. If you agree to receive
                          such materials, Tapa King will send you mail or e-mail
                          on behalf of the partners.
                        </p>
                        <p>
                          Tapa King reserves the right to use or disclose any
                          information to comply with any law, regulation or
                          legal request, or to cooperate in any law enforcement
                          investigation.
                        </p>
                        ...
                        <p>
                          To ensure the security of your Personal Data, Tapa
                          King utilizes industry standard encryption software
                          and technologies in the processing of visitors’ data.
                          We implement appropriate security measures that
                          protect against loss, misuse, or alteration of your
                          Personal Data. Despite these measures, you understand
                          that there may be circumstances beyond Tapa King’s
                          reasonable control that may render these security
                          measures insufficient and under such circumstance, you
                          agree that, Tapa King shall not be responsible or
                          liable for any unauthorized use, transfer, alteration,
                          loss, or damage to any information that Tapa King may
                          have gathered from you.
                        </p>

                        <h3 className="mb-2 font-bold">Retention of data</h3>
                        <p>
                          Unless otherwise required by law or other lawful
                          orders, Tapa King will only retain Personal Data for
                          such period necessary to serve the purpose/s for which
                          they were collected, or a period no longer than 13
                          months after the purposes for which the Personal Data
                          was collected have ceased.
                        </p>

                        <h3 className="mb-2 font-bold">Access</h3>
                        <p>
                          You are in control of the Personal Data you provide
                          us. You can access, modify, correct, update, or
                          withdraw your Personal Data by contacting us through
                        ...
                        <p>
                          ...
                          site, we do not have any control over your
                          information. We will not be responsible for the
                        ...
                        <p>
                          ...
                          2021. It may be necessary for TKI to update this
                          Privacy Policy periodically. Revised policy will be
                          posted here. ‍
                        </p>
                ...
                <Dialog>
                  ...
                  <DialogContent className="flex h-full max-h-[90vh] max-w-4xl flex-col border-none p-6 sm:p-8">
                    ...
                    <ScrollArea className="-mx-6 h-full pr-4 sm:-mx-8">
                      <div className="space-y-4 px-6 pb-6 text-left text-sm sm:px-8">
                        <p>
                          <strong>Promo Period:</strong> July 23, 2025 to
                          October 31, 2025
                          <br />
                        ...
                        <p>
                          ...
                          nationwide who meet the minimum purchase requirement
                          as stated in the official mechanics.
                        </p>
                        <p>
                          1.2 Employees of Tapa King, its affiliates,
                          advertising and promo agencies, and their relatives up
                          to the second degree of consanguinity or affinity are
                        ...
                        <p>
                          2.1 For every P750 dine-in purchase on a single
                          receipt from any participating Tapa King branch, the
                          customer is entitled to one (1) raffle entry.
                        </p>
                        <p>
                          2.2 Entries must be submitted via the official
                          E-Raffle System at tk38royalescaperaffle.com.
                        </p>
                        <p>
                        ...
                        <p>
                          4.1 Winners will be drawn electronically via the
                          System on November 7, 2025 under the supervision of a
                          DTI representative.
                        </p>
                        <p>
                        ...
                        <ul className="list-disc space-y-1 pl-6">
                          ...
                          <li>
                            Original receipt and the registered mobile number
                            used during entry registration (Note: Duplicated
                        ...
                        <p>
                          7.1 The E-Raffle System is the only official channel
                          for entry submissions.
                        </p>
                        <p>
                          7.2 Participants agree not to tamper, hack, or abuse
                          the system.
                        </p>
                        <p>
                          7.3 Tapa King is not liable for system outages, entry
                          errors, or internet connectivity issues that may
                          affect submission.
                        </p>
                        ...
                        <p>
                          ...
                          that are fraudulent, incomplete, duplicated, or
                        ...
                        <p>
                          ...
                          participation in the promo or the use of prizes
                          awarded.
                        </p>
                        ...
                        <p>
                          ...
                          of the Philippines, and disputes arising in connection
                          with the promo shall be resolved under Philippine
                          jurisdiction.
                        </p>
                      </div>
                    </ScrollArea>
