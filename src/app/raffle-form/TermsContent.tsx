export default function TermsContent() {
  return (
    <>
      ...
      <ul className="ml-6 list-disc">
        <li>Open to all Tapa King customers across all branches nationwide.</li>
      ...
      <h2 className="mt-4 text-lg font-bold text-warm-red sm:text-xl">
        Prize Details (Travel & Accommodation):
      </h2>
      <ul className="ml-6 list-disc">
        <li>
      ...
      <ul className="ml-6 list-disc">
        ...
        <li>
          Tapa King Inc. reserves the right to suspend prize release or void
          entries if misrepresentation or fraud is proven.
        </li>
        <li>
          Tapa King Inc. reserves the right to disclose and publish names,
          photos, and other information of winners on their official Facebook
          page, Instagram account, TikTok page, and website.
        </li>
      </ul>
      <h2 className="mt-4 text-lg font-bold text-warm-red sm:text-xl">
        Claiming Prizes:
      ...
      <ul className="ml-6 list-disc">
        ...
        <li>
          ...
          forfeited in favor of Tapa King Incorporation with prior DTI approval.
        </li>
      </ul>
      <h2 className="mt-4 text-lg font-bold text-warm-red sm:text-xl">
        Important Notes:
      ...
      <ul className="ml-6 list-disc">
        <li>
          Participants can only win once. If a name is drawn more than once, the
          prize with the higher value will be rewarded.
        </li>
        <li>
          20% tax on prizes exceeding P10,000.00 shall be shouldered by the
          winner.
        </li>
